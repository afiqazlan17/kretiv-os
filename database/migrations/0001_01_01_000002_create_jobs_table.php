...
// Laravel's default queue tables are named jobs/job_batches/failed_jobs,
// which collides with this app's own business "jobs" table (the Jobs
// module). Renamed to queue_* here and in config/queue.php — same fix
// applied in jobs.kretiv.co.
