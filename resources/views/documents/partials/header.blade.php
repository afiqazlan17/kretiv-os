<div class="hdr">
    ...
    <div class="contact-line" style="top:{{ ($t['sub'] ?? 24.8) + 35.4 }}pt;">Tel/WhatsApp: {{ config('kretivco.brand.phone') }} / {{ config('kretivco.brand.phone2') }} | Email: {{ config('kretivco.brand.email') }}</div>
